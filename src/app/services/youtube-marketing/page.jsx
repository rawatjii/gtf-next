...
import ServiceProjects from "@/app/components/services/Projects";
  ...
  return (
    <div className="pt-[110px]">
      ...
      <section>
        ...
        {/* <WeDo data={worksData} /> */}
        <WhyChooseUs data={whyChooseUsData} className="pt-[100px] border-t border-gray-800" />

        <ServiceProjects data={projectsData} className="pt-[100px] border-t border-gray-300" />
      </section>
    </div>
  );
};
