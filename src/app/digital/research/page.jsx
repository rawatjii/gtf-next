...
const overviewData="Compelling content and creative strategies engage your audience, drive brand storytelling, and foster lasting connections. Well-aligned content enhances user experience, boosts conversions, and builds brand loyalty.";
...
const DigitalResearch = () => {
  return (
    <div className='pt-[110px]'>
            ...
            {/* overview section */}
            <section>
                <HowWeWorkOverview headingData={headingData} overviewData={overviewData} />
                <WeDo data={worksData} />
            </section>
        </div>
  )
